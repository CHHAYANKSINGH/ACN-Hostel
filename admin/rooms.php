...
<style>
    body{
        color: white;
        background: url(images/b8.jpg) no-repeat center center fixed; 
            ...
            <table class="table table-hover table-striped table-condensed table-bordered">
                ...
                <tbody>
                    ...
                    <tr style="color: black;">
                            ...
                            <td class="py-2"><a href="update.php?id=<?php echo $rows['id'];?>&room_no=<?php echo $rows['room_no'];?>&seater=<?php echo $rows['seater'];?>&type=<?php echo $rows['type'];?>&fees=<?php echo $rows['fees'];?>&vacancy=<?php echo $rows['vacancy'];?>"><span class="glyphicon glyphicon-edit"></span> Edit/Update</a></td>
                    ...
                    ?>
                        ...
                        <tr style="color: black;">
                            ...
                            <td class="py-2"><?php echo $rows['fees']; ?></td>
                            <td class="py-2"><?php echo $rows['vacancy']; ?></td>
                            <td class="py-2"><a href="update_room.php?id=<?php echo $rows['id'];?>&room_no=<?php echo $rows['room_no'];?>&seater=<?php echo $rows['seater'];?>&type=<?php echo $rows['type'];?>&fees=<?php echo $rows['fees'];?>&vacancy=<?php echo $rows['vacancy'];?>"><span class="glyphicon glyphicon-edit"></span> Edit/Update</a></td>
                            <td class="py-2"><a href="delete_room.php?a=<?php echo $rows['id']; ?>"><span class="glyphicon glyphicon-remove-sign"></span> Remove</a></td>
                        </tr>
