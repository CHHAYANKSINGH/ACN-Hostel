...
<div class="container">
    ...
    <form class="form-horizontal" method="get">
        <div class="form-group">
            <label class="control-label col-sm-2 col-sm-offset-2" for="id">Student-ID:</label>
            <div class="col-sm-5">
...
if(isset($_GET['submit']))
{
    ...
    $address =  $_GET['address'];
    $email =  $_GET['email'];
    $sql = "update student set name='$name',gender='$gender',dob='$dob',number='$number',address='$address',email='$email' where id='$id'";
    $query = mysqli_query($conn,$sql);
    if($query)
	{
