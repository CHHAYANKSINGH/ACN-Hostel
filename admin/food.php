...
<style>
    body{
        color: white;
        background: url(images/b9.jpg) no-repeat center center fixed; 
...
<section>
    <div class="container">
        ...
        <label class="control-label col-sm-2 col-sm-offset-2" for="id" style="color: black;">Day-ID:</label>
            <div class="col-sm-5">
            ...
            <table class="table table-hover table-striped table-condensed table-bordered">
                ...
                <tbody>
                    ...
                    <tr style="color: black;">
                            ...
                            <td class="py-2"><a href="update_food.php?id=<?php echo $rows['id'];?>&day=<?php echo $rows['day'];?>&breakfast=<?php echo $rows['breakfast'];?>&lunch=<?php echo $rows['lunch'];?>&tiffin=<?php echo $rows['tiffin'];?>&dinner=<?php echo $rows['dinner'];?>"><span class="glyphicon glyphicon-edit"></span> Edit/Update</a></td>
                            <td class="py-2"><a href="delete_food.php?a=<?php echo $rows['id']; ?>"><span class="glyphicon glyphicon-remove-sign"></span> Remove</a></td>
                    </tr>
                    <?php
                            }
                        }
